var kibanaUrl = process.env.KIBANA;
...
function getChartUrl(username, bounds) {
    ...
    return kibanaUrl + "/#/visualize/create?embed&type=line&indexPattern=weight&_g=" + serializeToKibanaUrlFormat(g) + "&_a=" + serializeToKibanaUrlFormat(a);
};
